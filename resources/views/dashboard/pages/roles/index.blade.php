...
@section('content')
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body">
            <table id="table-roles" class="table table-hover mb-0">
                ...
                <tbody>
                    @forelse($roles as $role)
                        <tr>
                            ...
                            <td><span class="badge bg-secondary text-white">{{ $role->permissions_count }}
                                    permissions</span></td>
...
@push('scripts')
    <script>
        let table = new DataTable('#table-roles');
    </script>
@endpush
