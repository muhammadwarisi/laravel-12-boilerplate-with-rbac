...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="fw-bold mb-0">Tambah Role Baru</h4>
</div>
        ...
        <form method="POST" action="{{ route('admin.roles.store') }}">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                       value="{{ old('name') }}" placeholder="contoh: manager">
                ...
                <div class="card border mb-2">
                    <div class="card-header bg-light py-2">
                        <div class="form-check">
                            <input class="form-check-input toggle-group" type="checkbox" data-group="{{ $group }}" id="group_{{ $group }}">
                            <label class="form-check-label fw-semibold text-capitalize" for="group_{{ $group }}">
                                {{ $group }}
                            </label>
                        </div>
                    </div>
